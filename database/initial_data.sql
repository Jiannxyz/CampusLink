...
(
    'CSPC',
    'Camarines Sur Polythecnic Colleges',
    'Main Campus',
    'my.cspc.edu.ph',
    'Nabua',
    'Camarines Sur',
    'Philippines',
    'A polythecnic college in bicol that offer a free and qualty education..',
    'uploads/schools/state-u-placeholder.svg',
    'active'
),
(
    'UNC',
    'Universityy of Nueva Caceres',
    'Main Campus',
    'stateu.edu',
    'Naga',
    'Camarines Sur',
